...
def get_estadisticas_descriptivas(request, **kwargs):     
    ...
    datos_fecha=Data.objects.filter( base_time__year=anio_busqueda).values('measurement_id__name').annotate(    # filtro por  por año
    fecha=TruncDate('base_time')  # Trunca la fecha y hora a solo la fecha
